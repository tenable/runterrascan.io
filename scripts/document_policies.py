# This scrip documents the Rego policies in the
# policies directory of the Terrascan repository.
# To use it, run the script from the root of
# Terrscan's repository and copy the generated files
# into the runterrscan.io repo.
